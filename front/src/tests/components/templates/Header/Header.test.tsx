  ...
  test("Header render organisms Navigation", () => {
    ...
    const { getByTestId, getAllByTestId } = render(
      <Header
        ...
        listItems={arrayList}
        navigationSearchInputType="password"
        navigationSearchInputId="a"
        navigationSearchLabelFor="a"
    ...
    const getNavigationList = getAllByTestId("li-items").map(
      (item) => item.textContent
    );

    expect(getNavigationSearchInput.placeholder).toBe(
